...
int nb_epsilon = 12; // nb of epsilon values in the polymerized greybody factor tables
...
void read_gamma_tables_LQG(double ***gammas,double *gamma_epsilon,double *gamma_x){
	...
	if(a0 == 0.){
		sprintf(gamma_names[0],"./spin_0_LQG_highe.txt");
		sprintf(gamma_names[1],"./spin_1_LQG_highe.txt");
		sprintf(gamma_names[2],"./spin_2_LQG_highe.txt");
		sprintf(gamma_names[3],"./spin_0.5_LQG_highe.txt");
	}
	else{
...
void read_fits_LQG(double ***fits){
	...
	if(a0 == 0.){
		sprintf(table_names[0],"./spin_0_fits_highe.txt");
		sprintf(table_names[1],"./spin_1_fits_highe.txt");
		sprintf(table_names[2],"./spin_2_fits_highe.txt");
		sprintf(table_names[3],"./spin_0.5_fits_highe.txt");
	}
	else{
